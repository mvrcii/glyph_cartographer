...
class SF_Dataset(Dataset):
    def __init__(self, root_dir, images, transform, cfg, labels=None, mode="train", preload=False):
        self.cfg = cfg
        ...
        self.mode = mode
        self.label_shape = (1, cfg.label_size, cfg.label_size)
        self.label_shape_upscaled = (1, cfg.patch_size, cfg.patch_size)
    ...
    def __getitem__(self, idx):
        ...
        # channels, patch size, patch size
